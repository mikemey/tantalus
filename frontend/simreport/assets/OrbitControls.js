...
THREE.OrbitControls = function (object, domElement, lookAt = new THREE.Vector3()) {
  this.object = object
  ...
  var panLeft = createPanLeftFunc()

  const createPanUpFunc = () => {
    var v = new THREE.Vector3()
